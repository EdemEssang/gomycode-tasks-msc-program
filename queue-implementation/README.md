...
- Implement the Queue class as shown above, supporting operations like enqueue, dequeue, peek, and isEmpty.

Printer Queue Simulation:

- Implement the PrinterQueue class, which uses the Queue class to manage print jobs.
- Add methods to add jobs, process jobs, and print the queue.


Test the Solution:

- Test your implementation by adding multiple print jobs, processing them, and printing the queue.